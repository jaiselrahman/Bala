...
<div class="container">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" readonly id="suppid" name="suppid" value="${supplierInfo.supplierId}"/>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="suppname" name="suppname" value="${supplierInfo.supplierName}"/>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="suppadd" name="suppadd" value="${supplierInfo.supplierAddress}"/>
    </div>
  </div>
...
<div class="container">
	...
	<c:forEach items="${listSuppliries}" var="supplier">
	<tr>
