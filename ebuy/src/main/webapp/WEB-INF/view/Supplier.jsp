...
<div class="container">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="suppname" placeholder="Enter supplier name" name="suppname">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="suppadd" placeholder="Enter supplier address" name="suppadd">
